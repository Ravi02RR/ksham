...
const Home = () => {
  ...
  return (
    <div>
      ...
      <div className="hero min-h-screen relative bg-yellow-200" id='secs2'>
        <div className="hero-content flex flex-col lg:flex-row lg:gap-24 items-center justify-center  relative z-10">
          <div className="w-full lg:w-[95%] h-[300px] lg:h-[450px] rounded-lg shadow-2xl overflow-hidden mb-8 lg:mb-0">
            <canvas id='canvas3d' className="w-full h-full"></canvas>
          </div>
          <div className="text-center lg:text-left text-gray-800  font-mono ">
            <h1 className="text-3xl lg:text-5xl font-bold mb-4 leading-tight">&quot;Introducing&quot;</h1>
            <h1 className="text-4xl lg:text-4xl font-bold mb-4 leading-tight">&quot;World&apos;s 1st Smart Aid Glasses&quot;</h1>
            ...
            <ul className="mb-6 list-disc text-lg lg:text-2xl">
              <li className="inline-block mr-4"><span className="font-extrabold text-4xl lg:text-4xl">&quot;Deaf&quot;,</span></li>
              <li className="inline-block mr-4"><span className="font-extrabold text-4xl lg:text-4xl ">&quot;Mute&quot;,</span></li>
              <li className="inline-block"><span className="font-extrabold text-4xl lg:text-6xl">&quot;Blind&quot;</span></li>
            </ul>
            ...
            <Link to={'/Contact'}><button className="btn btn-Ghost text-lg lg:text-xl">Get Early Access</button></Link>
          </div>
        </div>
      </div>
